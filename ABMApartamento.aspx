<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ABMApartamento.aspx.cs" Inherits="ABMApartamento" %>
...
<form id="form1" runat="server">
        <div class="container">
            <span style="font-size: 14pt; color: #006699; text-decoration: underline">
                <strong>Mantenimiento Apartamento</strong>
            </span>
            <br />
            <br />
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                      <asp:TextBox ID="txtPiso" runat="server" Width="180px"></asp:TextBox>
                  </td>
                  <td></td>
                </tr>
                <tr>
                  <th scope="row">Gastos Comunes: </th>
                  <td>
                      <asp:TextBox ID="TxtGastosComunes" runat="server" Width="180px"></asp:TextBox>
                  </td>
                  <td></td>
                </tr>
                <tr>
